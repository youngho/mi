문서에 있는 내용을 바탕으로 기획서를 마크다운 형식으로 정리했습니다. 아래 내용을 복사하여 `.md` 파일로 저장해 사용하세요.
...
```json
{
  ...
  "version": "1.0.0",
  "bundleUrl": "[https://api.pinksoft.io/missions/spy_01.bundle](https://api.pinksoft.io/missions/spy_01.bundle)",
  "requiredLevel": 5,
  "entryFee": 500,
  "timeLimit": 180,
  "targetScore": 5000

 ...
 *
 * ---------------------------------------------------------------------------
 * Photodiode / LM393 센서 모듈 — 재귀반사 차단(Beam Interrupt) · Sync
 * ---------------------------------------------------------------------------
...
// ---- Motor defaults ----
static const uint32_t CLK_HZ_DEFAULT = 1000;
...
static bool computeTheta2(float *outDeg, uint32_t eventUs)
{
